import { Form, FormLayout, Divider, Card, TextField, RadioButton, Button, Text, InlineGrid, InlineStack } from '@shopify/polaris';
...
export default function EditRule({ rule }) {
    ...
    const [statusValue, setStatusValue] = useState(status ?? STATUS_ROLES.ENABLE);
        ...
        <Card>
            <Form onSubmit={handleSubmit}>
                <FormLayout>
                    ...
                    <InlineGrid gap="500" columns={2} >
                        <Card>
                            <InlineGrid gap="100" columns={1}  >
                                ...
                                />
                                <ProductTag setActiveTags={setActiveTags} activeTags={activeTags} applyType={applyType} />
                            </InlineGrid  >
                        </Card>
                        <Card>
                            <InlineGrid gap="100" columns={1} >
                                ...
                                <Divider />
                                <Text variant="bodyLg" as="h3">
                                    {discountType === DISCOUNT_TYPE.PERCENT ? "Percent(%)" : "Amount"}
                                </Text>
                                <TextField
                                    value={value}
                    ...
                    <ProductionList status={statusValue} activeTags={activeTags} applyType={applyType} discountType={discountType} value={value} />
